...
function AuthPanel({ mode, setMode, onClose, onAuthenticated }) {
  ...
  const [recoveryForm, setRecoveryForm] = useState({ email_or_phone: '', code: '', newPassword: '', confirmPassword: '' });
  ...
  const submitForgotPassword = async (event) => {
    ...
    setMessage('');
    try {
      const identifier = recoveryForm.email_or_phone.trim();
      ...
      setMessage(res.message || 'Recovery code sent successfully.');
      setMode('reset');
    } catch (err) {
